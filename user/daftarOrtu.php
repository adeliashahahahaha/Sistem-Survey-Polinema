...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $insert1 = $db->query("INSERT INTO t_responden_ortu (username, password, responden_nama, responden_jk, responden_umur, responden_hp, responden_pendidikan, responden_pekerjaan, responden_penghasilan, mahasiswa_nim, mahasiswa_nama, mahasiswa_prodi) 
    VALUES ('$username', '$password', '$responden_nama', '$responden_jk', '$responden_umur', '$responden_hp', '$responden_pendidikan', '$responden_pekerjaan', '$responden_penghasilan', '$mahasiswa_nim', '$mahasiswa_nama', '$mahasiswa_prodi')");
...
<header class="header">
    ...
    <div class="bg-img">
        <form class="container" id="register-form" action="" method="POST">
            <h2>Daftar Akun Orang Tua Mahasiswa</h2>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter your age" name="responden_umur" required>
            </div>
            ...
            <div class="form-group">
                <label for="responden_pendidikan"><b>Pendidikan Terkahir</b></label>
                <input type="text" class="form-control" placeholder="Enter your email" name="responden_pendidikan" required>
            </div>

            <div class="form-group">
                <label for="responden_pekerjaan"><b>Pekerjaan</b></label>
                <input type="text" class="form-control" placeholder="Enter your occupation" name="responden_pekerjaan" required>
            </div>

            <div class="form-group">
                <label for="responden_penghasilan"><b>Penghasilan</b></label>
                <input type="text" class="form-control" placeholder="Enter your email" name="responden_penghasilan" required>
            </div>
      

            <div class="form-group">
                <label for="mahasiswa_nim"><b>NIM Mahasiswa</b></label>
                <input type="text" class="form-control" placeholder="Enter student NIM" name="mahasiswa_nim" required>
            </div>

            <div class="form-group">
                <label for="mahasiswa_nama"><b>Nama Mahasiswa</b></label>
                <input type="text" class="form-control" placeholder="Enter student name" name="mahasiswa_nama" required>
            </div>

            <div class="form-group">
                <label for="mahasiswa_prodi"><b>Program Studi Mahasiswa</b></label>
                <input type="text" class="form-control" placeholder="Enter student study program" name="mahasiswa_prodi" required>
            </div>
