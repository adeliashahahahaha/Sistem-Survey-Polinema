...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $insert1 = $db->query("INSERT INTO t_responden_tendik (username, password, responden_nama, responden_nopeg, responden_unit) VALUES ('$username', '$password', '$responden_nama', '$responden_nopeg', '$responden_unit')");
...
<header class="header">
    ...
    <div class="bg-img">
        <form class="container" id="register-form" action="" method="POST">
            <h2>Daftar Akun Tenaga Pendidik</h2>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter your employee number" name="responden_nopeg" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter unit" name="responden_unit" required>
            </div>
