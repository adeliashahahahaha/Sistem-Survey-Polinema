...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $insert1 = $db->query("INSERT INTO t_responden_alumni (username, password, responden_nim, responden_nama, responden_prodi, responden_email, responden_hp, tahun_lulus) VALUES ('$username', '$password', '$responden_nim', '$responden_nama', '$responden_prodi', '$responden_email', '$responden_hp', '$tahun_lulus')");
    ...
    <div class="bg-img">
        <form class="container" id="register-form" action="" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter your graduated year" name="tahun_lulus" required>
            </div>
