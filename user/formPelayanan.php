...
include_once 'model/SoalPelayanan.php';
...
$soalPelayanan = new SoalPelayanan($db, $responseTable, $responseColumn);

$soal = $soalPelayanan->getSoalByKategori(3); 
$kategori_id = 3;
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $soalPelayanan->postJawaban($data); // Simpan jawaban ke database

    // Calculate and save evaluation scores
    $soalPelayanan->calculateScores();
...
<head>
    ...
    <title>Survey Kualitas Pelayanan Politeknik Negeri Malang</title>
    <style>
        body {
...
<body>
    <div class="form-container">
        <div class="form-header">
            <h1>Survey Kualitas Pelayanan Politeknik Negeri Malang</h1>
        </div>

        <div class="form-description">
            <p><strong>Deskripsi:</strong></p>
            <p>Survei ini bertujuan untuk mengevaluasi kualitas pelayanan yang diberikan oleh Politeknik Negeri Malang.
