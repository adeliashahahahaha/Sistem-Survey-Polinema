...
$ortu = new Ortu($db);
$data = $ortu->getOrtuProfile($username);
            ...
            <div class="profile-border">
                <div class="profile-info">
                    ...
                    <div class="info-item">
                        ...
                        <p><?= $data['responden_jk'] !== null ? $data['responden_jk'] : '-' ?></p>
                    </div>
                    <div class="info-item">
                        <label>Umur</label>
                        <p><?= $data['responden_umur'] !== null ? $data['responden_umur'] : '-' ?></p>
                    </div>
                    <div class="info-item">
                        <label>No Hp</label>
                    ...
                    <div class="info-item">
                        ...
                        <p><?= $data['responden_pendidikan'] !== null ? $data['responden_pendidikan'] : '-' ?></p>
                    </div>
                    <div class="info-item">
                        <label>Pekerjaan</label>
                        <p><?= $data['responden_pekerjaan'] !== null ? $data['responden_pekerjaan'] : '-' ?></p>
                    </div>

                    <div class="info-item">
                        <label>Nama Mahasiswa</label>
                        <p><?= $data['mahasiswa_nama'] !== null ? $data['mahasiswa_nama'] : '-' ?></p>
                    </div>
                    <div class="info-item">
                        <label>Nim Mahasiswa</label>
                        <p><?= $data['mahasiswa_nim'] !== null ? $data['mahasiswa_nim'] : '-' ?></p>
                    </div>
                    <div class="info-item">
                        <label>Prodi Mahasiswa</label>
                        <p><?= $data['mahasiswa_prodi'] !== null ? $data['mahasiswa_prodi'] : '-' ?></p>
                    </div>
