...
include_once 'model/SoalPendidikan.php';
...
$soalPendidikan = new SoalPendidikan($db, $responseTable, $responseColumn);

$soal = $soalPendidikan->getSoalByKategori(1); // Ambil soal kategori Pendidikan
$kategori_id = 1;
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $soalPendidikan->postJawaban($data); // Simpan jawaban ke database

    // Calculate and save evaluation scores
    $soalPendidikan->calculateScores();
...
<head>
    ...
    <title>Survey Kualitas Pendidikan Politeknik Negeri Malang</title>
    <style>
        body {
...
<body>
    <div class="form-container">
        <div class="form-header">
            <h1>Survey Kualitas Pendidikan Politeknik Negeri Malang</h1>
        </div>

        <div class="form-description">
            <p><strong>Deskripsi:</strong></p>
            <p>Survei ini bertujuan untuk mengevaluasi kualitas pendidikan yang diberikan oleh Politeknik Negeri Malang.
