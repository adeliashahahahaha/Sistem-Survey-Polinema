...
include_once 'model/SoalLulusan.php';
...
$soalLulusan = new SoalLulusan($db, $responseTable, $responseColumn);

$soal = $soalLulusan->getSoalByKategori(4); 
$kategori_id = 4;
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $soalLulusan->postJawaban($data);

    // Calculate and save evaluation scores
    $soalLulusan->calculateScores();
...
<head>
    ...
    <title>Survey Kualitas Lulusan Politeknik Negeri Malang</title>
    <style>
        body {
...
<body>
    <div class="form-container">
        <div class="form-header">
            <h1>Survey Kualitas Lulusan Politeknik Negeri Malang</h1>
        </div>

        <div class="form-description">
            <p><strong>Deskripsi:</strong></p>
            <p>Survei ini bertujuan untuk mengevaluasi kualitas lulusan yang diberikan oleh Politeknik Negeri Malang.
