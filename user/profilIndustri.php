...
$industri = new Industri($db);
$data = $industri->getIndustriProfile($username);
        ...
        <main>
            <div class="profile-border">
                <div class="profile-info">
                    ...
                    <div class="info-item">
                        <label>Jabatan</label>
                        <p><?= $data['responden_jabatan'] !== null ? $data['responden_jabatan'] : '-' ?></p>
                    </div>
                    <div class="info-item">
                        <label>Perusahaan</label>
                        <p><?= $data['responden_perusahaan'] !== null ? $data['responden_perusahaan'] : '-' ?></p>
                    </div>
                    <div class="info-item">
                        <label>Email</label>
                    ...
                    <div class="info-item">
                        <label>Kota</label>
                        <p><?= $data['responden_kota'] !== null ? $data['responden_kota'] : '-' ?></p>
                    </div>
