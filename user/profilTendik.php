...
$tendik = new Tendik($db);
$data = $tendik->getTendikProfile($username);
        ...
        <main>
            <div class="profile-border">
                <div class="profile-info">
                    <div class="info-item">
                        <label>Nip</label>
                        <p><?= $data['responden_nopeg'] !== null ? $data['responden_nopeg'] : '-' ?></p>
                    </div>
                    <div class="info-item">
                    ...
                    <div class="info-item">
                        <label>Unit</label>
                        <p><?= $data['responden_unit'] !== null ? $data['responden_unit'] : '-' ?></p>
                    </div>
