...
class jIndustri{
    ...
    public function getindustriById($id){
        ...
        $query = $this->db->prepare("SELECT t.jawaban_industri_id, t.responden_industri_id, s.soal_pertanyaan, t.jawaban, k.kategori_nama, DATE_FORMAT(t.responden_tanggal, '%d-%m-%Y %H:%i:%s') AS responden_tanggal
