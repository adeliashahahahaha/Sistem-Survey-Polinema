...
class jAlumni{
    ...
    public function getalumniById($id){
        ...
        $query = $this->db->prepare("SELECT t.jawaban_alumni_id, t.responden_alumni_id, s.soal_pertanyaan, t.jawaban, k.kategori_nama, DATE_FORMAT(t.responden_tanggal, '%d-%m-%Y %H:%i:%s') AS responden_tanggal
