              ...
              <?php 
                ...
                while($row = $data->fetch_assoc()){
                    echo '<tr>
                      ...
                      <td>
                      <a title="Lihat Detail" href="industri_detail.php?act=detail&id=' .$row['responden_industri_id'].'" class="btn btn-info btn-sm"><i class="fa fa-eye"></i>       Detail</a>
                    </td>
                    </tr>';
                    $i++;
                }
