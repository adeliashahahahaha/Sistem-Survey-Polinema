              ...
              <?php 
                ...
                while($row = $data->fetch_assoc()){
                    echo '<tr>
                      ...
                      <td>
                      <a title="Lihat Detail" href="tendik_detail.php?act=detail&id=' .$row['responden_tendik_id'].'" class="btn btn-info btn-sm"><i class="fa fa-eye"></i>       Detail</a>
                    </td>
                    </tr>';
                    $i++;
                }
